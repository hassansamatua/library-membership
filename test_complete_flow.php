...
// Test user 26
$userId = 26;
$paymentReference = 'TEST-FINAL-' . time();

echo "1. Testing complete payment flow for user $userId\n";
...
$insertPaymentStmt->execute([$userId, 40000, 'test', $paymentReference]);
...
$updateMembershipStmt->execute([40000, $paymentReference, $userId]);
